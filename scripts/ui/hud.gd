...
func _build_ui() -> void:
	...
	controls_label.text = "WASD: Move | Ctrl: Crouch | F: Interact | Tab: Inventory | LMB: Hand 1 | RMB: Aim (Hand 2 if dual) | R / Alt+R: Reload | V / Alt+V: Fire Mode | X / Alt+X: Ammo | Q/E: Loadout | Esc: Cursor"
